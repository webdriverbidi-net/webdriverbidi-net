...
public class SetTextLayoutModeOverrideCommandParametersTests
{
    [Fact]
    public void TestCommandName()
    {
        SetTextLayoutModeOverrideCommandParameters properties = new();
        Assert.Equal("emulation.setTextLayoutModeOverride", properties.MethodName);
    }
    ...
    public void TestCanSerializeParameters()
    {
        ...
        Assert.True(serialized.ContainsKey("textLayoutMode"));
        JToken? textLayoutMode = serialized["textLayoutMode"];
        Assert.NotNull(textLayoutMode);
        Assert.Equal(JTokenType.Null, textLayoutMode.Type);
    }

    [Fact]
    public void TestCanSerializeParametersWithMobile()
    {
        SetTextLayoutModeOverrideCommandParameters properties = new()
        {
        ...
        JToken? textLayoutMode = serialized["textLayoutMode"];
        Assert.NotNull(textLayoutMode);
        Assert.Equal(JTokenType.String, textLayoutMode.Type);
        Assert.Equal("mobile", textLayoutMode.Value<string>());
    }
    ...
    {
        SetTextLayoutModeOverrideCommandParameters properties = SetTextLayoutModeOverrideCommandParameters.ResetTextLayoutModeOverride;
        Assert.NotNull(properties);

        Assert.Null(properties.TextLayoutMode);
    ...
    {
        SetTextLayoutModeOverrideCommandParameters firstInstance = SetTextLayoutModeOverrideCommandParameters.ResetTextLayoutModeOverride;
        SetTextLayoutModeOverrideCommandParameters secondInstance = SetTextLayoutModeOverrideCommandParameters.ResetTextLayoutModeOverride;
