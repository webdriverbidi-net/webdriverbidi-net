...
public class CookieTests
{
    ...
    public void TestDeserializeWithMissingNameThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json), Throws.InstanceOf<JsonException>().With.Message.Contains("missing required properties, including the following: name"));
    }
    ...
    public void TestDeserializeWithMissingValueThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json), Throws.InstanceOf<JsonException>().With.Message.Contains("missing required properties, including the following: value"));
    }
    ...
    public void TestDeserializeWithMissingDomainThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json), Throws.InstanceOf<JsonException>().With.Message.Contains("missing required properties, including the following: domain"));
    }
    ...
    public void TestDeserializeWithMissingPathThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json), Throws.InstanceOf<JsonException>().With.Message.Contains("missing required properties, including the following: path"));
    }
    ...
    public void TestDeserializeWithMissingSecureThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json), Throws.InstanceOf<JsonException>().With.Message.Contains("missing required properties, including the following: secure"));
    }
    ...
    public void TestDeserializeWithMissingHttpOnlyThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json), Throws.InstanceOf<JsonException>().With.Message.Contains("missing required properties, including the following: httpOnly"));
    }
    ...
    public void TestDeserializeWithMissingSameSiteThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json), Throws.InstanceOf<JsonException>().With.Message.Contains("missing required properties, including the following: sameSite"));
    }
    ...
    public void TestDeserializeWithMissingSizeThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json), Throws.InstanceOf<JsonException>().With.Message.Contains("missing required properties, including the following: size"));
    }
