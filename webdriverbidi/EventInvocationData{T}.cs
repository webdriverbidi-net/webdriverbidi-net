// <copyright file="EventInvocationData{T}.cs" company="WebDriverBidi.NET Committers">
...
public class EventInvocationData<T>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EventInvocationData{T}"/> class.
    /// </summary>
    ...
    public EventInvocationData(T eventData, Dictionary<string, object?> additionalData)
    {
