...
| `emulation.setTextLayoutModeOverride` | [SetTextLayoutModeOverrideCommandParameters](xref:WebDriverBiDi.Emulation.SetTextLayoutModeOverrideCommandParameters) | [SetTextLayoutModeOverrideCommandResult](xref:WebDriverBiDi.Emulation.SetTextLayoutModeOverrideCommandResult) | [Emulation Guide](modules/emulation.md) |
