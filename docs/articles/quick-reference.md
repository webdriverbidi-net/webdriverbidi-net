...
| Add data collector | `AddDataCollectorCommandParameters p = new AddDataCollectorCommandParameters(1024 * 1024, DataType.Response); p.Contexts.Add(contextId); await driver.Network.AddDataCollectorAsync(p);` |
