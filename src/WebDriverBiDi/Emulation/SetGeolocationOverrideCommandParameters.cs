...
public class SetGeolocationOverrideCommandParameters : CommandParameters<SetGeolocationOverrideCommandResult>
{
    ...
    /// <summary>
    /// Gets a pre-initialized instance of <see cref="SetGeolocationOverrideCoordinatesCommandParameters"/>
    ...
    /// </summary>
    public static SetGeolocationOverrideCoordinatesCommandParameters ResetGeolocationOverride => new();
